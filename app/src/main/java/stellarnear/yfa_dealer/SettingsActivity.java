...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || InventoryPreferenceFragment.class.getName().equals(fragmentName)
    ...
    public static class InventoryPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            allEquipments= new AllEquipments(getContext());
            addPreferencesFromResource(R.xml.pref_inventory);
            setHasOptionsMenu(true);
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
            ...
            switch (key) {
                ...
                case "show_equipment":
                  allEquipments.showEquipment(getActivity());
            }
            return true;
        }
    }
