...
public class _oldSpell extends AppCompatActivity implements Serializable,Cloneable {
    ...
    public _oldSpell(Context mC, _oldSpell spell){ //copying spell
    ...
    public _oldSpell(String ID, String name, String descr, Integer n_sub_spell, String dice_type, Double n_dice_per_lvl, int cap_dice, String dmg_type, String range, String cast_time, String duration, String compo, String rm, String save_type, int rank, Context mC){
