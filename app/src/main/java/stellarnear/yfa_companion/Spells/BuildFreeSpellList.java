...
public class BuildFreeSpellList extends AppCompatActivity {
    ...
    public static BuildFreeSpellList getInstance(Context mC) {  //pour eviter de relire le xml à chaque fois
        if (instance==null){
    ...
    private BuildFreeSpellList(Context mC){  // on construit la liste qu'une fois dans MainActivityFragmentSpell donc pas besoin de singleton
